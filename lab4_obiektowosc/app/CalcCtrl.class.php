<?php
    ...
    require_once $conf->root_path.'/app/CalcRes.class.php';
...
class CalcCtrl{
    ...
    public function genView(){
		...
		$smarty->assign('page_title','Lab_04');
		$smarty->assign('page_description','Moja apka z obiektowością.');
		$smarty->assign('page_header','Laboratorium 4');
